...
export const AboutModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
      ...
      <div className="bg-gray-800 border border-blue-900/50 rounded-lg max-w-4xl w-full max-h-[90vh] flex flex-col shadow-2xl">
        <div className="flex items-center justify-between p-4 border-b border-gray-700/50 flex-shrink-0">
          <div className="flex items-center">
            <QIcon className="w-7 h-7 text-blue-400 mr-3" />
            <div>
              <h2 className="text-xl font-bold text-white">Q Protocol for Microscopes</h2>
              <p className="text-sm text-gray-400">A2AC LLC</p>
            </div>
          </div>
        ...
        <div className="p-6 overflow-y-auto text-gray-300 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm">
            ...
            <div className="bg-green-900/20 border border-green-800/50 rounded-lg p-4">
              <h4 className="text-lg font-bold text-green-300 mb-2">✅ Q Protocol Way (New)</h4>
          ...
          <div className="bg-gray-900/50 border border-gray-700/50 rounded-lg p-4">
              ...
              <p className="text-sm text-center text-gray-400 mb-4">A real 200+ line MATLAB script is converted into just 6 lines of Q Protocol.</p>
  ...
  [Max_Amp(i)] = Find_maximal_zernike_amplitude(...);
                   ...
                   <div>
                      <h5 className="font-semibold text-green-300 mb-2">After (Q Protocol)</h5>
                      <pre className="bg-gray-800 p-2 rounded text-xs font-mono text-green-200/80 h-full"><code>{`# Adaptive Optics - By A2AC LLC
...
RESULTS|ENHANCEMENT[2.5x]→SAVE[Data]→PLOT|COMPLETE`}</code></pre>
          ...
          <div className="bg-gray-900/50 border border-gray-700/50 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-400 mb-3">This app is a high-fidelity demonstration. The Q Protocol commands are real and production-ready. When integrated, these simulated commands will control actual microscope hardware.</p>
            <div className="text-sm grid grid-cols-2 gap-4">
                <div className="bg-gray-800 p-3 rounded">
                 ...
                 <div className="bg-gray-800 p-3 rounded">
                    <h5 className="font-semibold text-green-300">In Production</h5>
                    <ul className="list-disc list-inside mt-2 text-gray-300">
          ...
          <div>
              <h4 className="text-lg font-semibold text-gray-100 mb-2">What Users Are Saying</h4>
              <div className="space-y-3 text-sm italic">
                <blockquote className="border-l-4 border-blue-500 pl-4 py-1 bg-gray-900/50 rounded-r-md">
                  <p className="text-gray-300">"Q Protocol reduced our experiment setup from 2 hours to 5 minutes!"</p>
           ...
           <div>
              ...
              <p className="text-sm leading-relaxed">
                  <strong>A2AC LLC</strong> created the Q Protocol to make complex systems simple. The protocol compresses traditional code by 100:1 while maintaining perfect clarity and functionality. Q Protocol was designed to help people spend less time coding and more time on what matters.
              </p>
           </div>
            </>
          ) : (
