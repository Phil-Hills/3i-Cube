...
export const BeakerIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 0 1-.659 1.591L5 14.5M9.75 3.104c.251.023.501.05.75.082a2.25 2.25 0 0 1 2.25 2.25v5.714a2.25 2.25 0 0 0 .659 1.591L19.5 14.5M9.75 11.25l.386.386a2.25 2.25 0 0 1 .659 1.591v3.493a2.25 2.25 0 0 1-1.348 2.057l-1.31-.656a2.25 2.25 0 0 0-1.682.004l-.386.193m0 0a2.25 2.25 0 0 1-2.25-2.25v-5.714a2.25 2.25 0 0 1 2.25-2.25c.249.032.499.059.75.082Zm6.136 5.862-3.86-.386a2.25 2.25 0 0 0-1.682.004l-.386.193m0 0a2.25 2.25 0 0 1-2.25-2.25v-5.714a2.25 2.25 0 0 1 2.25-2.25c.249.032.499.059.75.082m6.136 5.862a2.25 2.25 0 0 0 .659-1.591v-3.493a2.25 2.25 0 0 0-1.348-2.057l-1.31.656a2.25 2.25 0 0 1-1.682-.004l-.386-.193m0 0a2.25 2.25 0 0 1 2.25 2.25v5.714a2.25 2.25 0 0 1-2.25 2.25c-.249-.032-.499-.059-.75-.082Z" />
  </svg>
);
...
export const LoaderIcon: React.FC<IconProps> = ({ className }) => (
    <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path clipRule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25zm0 1.5a8.25 8.25 0 100 16.5 8.25 8.25 0 000-16.5z" fill="currentColor" opacity="0.2"/>
      <path d="M12 2.25a9.75 9.75 0 019.75 9.75h-1.5A8.25 8.25 0 0012 3.75v-1.5z" fill="currentColor"/>
    </svg>
);
...
export const NvidiaIcon: React.FC<IconProps> = ({ className }) => (
...
export const ChatBubbleBottomCenterTextIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a5.969 5.969 0 0 1-.474-.065 4.48 4.48 0 0 0 .978-2.025c.09-.457-.133-.901-.467-1.226C3.93 16.178 3 14.189 3 12c0-4.556 4.03-8.25 9-8.25s9 3.724 9 8.25Z" />
    </svg>
);
