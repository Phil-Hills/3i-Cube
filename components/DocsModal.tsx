...
### Before: Python (1655 lines)
\`\`\`python
# Full Python script for a High-Content Screening (HCS) workflow.
...
### Before: Python (473 lines)
\`\`\`python
# Python script for image-based Adaptive Optics (AO) correction.
...
### Before: Python (246 lines)
\`\`\`python
# Python script for a multi-ROI FRAP experiment.
